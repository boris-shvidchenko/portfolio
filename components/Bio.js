                ...
                <div className={`bg-gradient-to-b from-black/70 md:bg-none text-white ${darkTheme ? 'md:text-[#efefef]' : 'md:text-black'} pt-32 md:pt-0 pb-8 md:pb-0 absolute top-0 px-7 md:px-none md:relative md:top-0`}>
                    ...
                    <div className='mt-5 sm:flex space-x-5 md:mt-3 lg:mt-10'>
                        <Link 
                            ...
                            target='_blank' 
                            className={`w-28 flex space-x-2 rounded-md md:border ${darkTheme ? 'md:border-none' : 'md:border-black'} p-2 ${darkTheme ? 'bg-[#424141]' : 'bg-gray-400'} ${darkTheme ? 'md:bg-[#424141]' : 'md:bg-[#d7dee1]'} min-w-fit onhover-social`}>
                        ...
                        <Link 
                            ...
                            target='_blank' 
                            className={`absolute left-2 w-28 mt-3 sm:mt-0 sm:left-0 sm:static flex space-x-2 rounded-md md:border ${darkTheme ? 'md:border-none' : 'md:border-black'} p-2 ${darkTheme ? 'bg-[#424141]' : 'bg-gray-400'} ${darkTheme ? 'md:bg-[#424141]' : 'md:bg-[#d7dee1]'} min-w-fit onhover-social`}>
