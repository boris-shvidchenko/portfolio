        ...
        <main className='md:px-20 xl:px-32 2xl:px-40 md:h-[calc(100vh-108px)] lg:h-[calc(100vh-112px)]'>
            <section className='md:flex md:space-x-6 lg:space-x-10 md:mt-8'>
                ...
                <div className={`bg-gradient-to-b from-black/70 md:bg-none text-white ${textColor} pt-[120px] md:pt-0 pb-8 md:pb-0 absolute top-0 px-7 md:px-none md:relative md:top-0`}>
                    ...
                    <div className={`${mobileView.width <= 470 ? 'text-sm' : ''}`}>
                    ...
                    <div className='mt-5 sm:flex space-x-5 md:mt-3 lg:mt-10'>
                        ...
                        <Link 
                            ...
                            target='_blank' 
                            className={`absolute left-2 w-28 ${mobileView.width <= 470 ? 'text-sm' : ''} mt-3 sm:mt-0 sm:left-0 sm:static flex space-x-2 rounded-md md:border ${linkBorderColor} p-2 ${linkBgColor} ${linkBgColorMedium} min-w-fit onhover-social onhover`}>
