    ...
    return (
        <main className='md:px-20 xl:px-32 2xl:px-40 h-full'>
            <section className='md:flex md:space-x-6 lg:space-x-10 md:mt-8'>
                ...
                <div className='bg-gradient-to-b from-black/70 md:bg-none text-white md:text-black pt-32 md:pt-0 pb-8 md:pb-0 absolute top-0 px-7 md:px-none md:relative md:top-0'>
                    ...
                    <div className='flex space-x-5 mt-3 lg:mt-10'>
                        <Link 
                            ...
                            target='_blank' 
                            className='flex space-x-2 rounded-md md:border md:border-black p-2 bg-gray-400 md:bg-white min-w-fit'>
