...
export default function Modal() {
    ...
    return (
        <div className='flex flex-col pt-52 items-center space-y-10 mx-auto fixed top-0 w-screen h-screen text-white bg-black/80'>
            ...
            <Link href='/about'><p className='text-4xl'>About</p></Link>
            <Link href='/projects'><p className='text-4xl'>Projects</p></Link>
            <Link href='/contact'><p className='text-4xl mb-6'>Contact</p></Link>
