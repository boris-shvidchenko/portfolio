...
export default function Modal() {
    ...
    return (
        <nav onClick={closeModal} className='flex flex-col pt-28 items-center space-y-10 mx-auto fixed top-0 w-screen h-screen text-white bg-black/80 z-20 headers'>
