...
export default function ContactContainer() {
    ...
    return(
        <main className={`pb-60 md:pb-0 px-7 pt-10 md:pt-0 md:px-20 xl:px-32 2xl:px-40 md:h-[calc(100vh-140px)] lg:h-[calc(100vh-144px)] ${darkTheme ? 'text-[#efefef]' : 'md:text-black'}`}>
            <div id='contact-container' className='relative -top-[125px]'></div>
            ...
            <form className={`form ${darkTheme ? 'border' : ''} border-[#4e4e4e] md:w-[525px] p-3 rounded-md ${darkTheme ? 'bg-[#272727]' : 'bg-[#efefef]'}`}>
                ...
                <section className='form pb-5'>
                    ...
                    <textarea id='message' name='message' rows='4' cols='40' required onChange={changeFormData} className={`border form-input max-h-80 min-h-[34px] ${darkTheme ? 'bg-[#efefef] text-black' : ''} px-2 py-1`}/>
                </section> 
