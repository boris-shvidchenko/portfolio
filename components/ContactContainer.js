...
export default function ContactContainer() {
    ...
    return(
        <main className={`pb-60 md:pb-0 px-7 pt-10 md:pt-0 md:px-20 xl:px-32 2xl:px-40 md:h-[calc(100vh-108px)] lg:h-[calc(100vh-112px)] ${darkTheme ? 'text-[#efefef]' : 'md:text-black'}`}>
            ...
            <form className={`form ${darkTheme ? 'border' : ''} shadow-sm border-[#4e4e4e] md:w-[525px] p-3 rounded-md ${darkTheme ? 'bg-[#272727]' : 'bg-[#efefef]'}`}>
                ...
                <input type='submit' value='Submit' onClick={submitForm} className={`w-28 rounded-md p-1 ${darkTheme ? 'bg-[#424141]' : 'bg-gray-400'} ${darkTheme ? 'md:bg-[#424141]' : ''} min-w-fit onhover-social onhover`} />
