...
export default function ProjectDetails({ data }) {
    ...
    return (
        <main className={`px-7 pb-4 pt-5 md:px-20 xl:px-32 2xl:px-40 md:mt-8 md:flex md:space-x-6 lg:space-x-10 h-screen md:h-[calc(100vh-108px)] lg:h-[calc(100vh-112px)] ${darkTheme ? 'text-white' : 'md:text-black'}`}>
