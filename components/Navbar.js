...
export default function Navbar() {
    ...
    return(
        <nav className={`${darkTheme ? 'border-b border-b-[#1a1a1a] md:border-none' : 'border-b border-b-[#cacaca] md:border-none'} bg-[#272727] flex justify-between px-7 md:px-20 xl:px-32 2xl:px-40 py-9 items-center sticky top-0 ${darkTheme ? 'text-white' : 'text-black'} ${darkTheme ? 'md:bg-[#424141]' : 'bg-[#efefef]'} z-10`}>
